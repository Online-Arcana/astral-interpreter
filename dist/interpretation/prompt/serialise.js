import { interpretationVoiceProfile, interpretiveVoiceContract, semanticRegisterContract, } from "../voice/profile.js";
const privateControls = (task) => [
...
export const serialiseInterpretationPrompt = (input) => ({
