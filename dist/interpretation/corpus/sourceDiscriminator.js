...
const bool = (value, key) => {
    ...
    if (typeof selected !== "boolean")
        throw new TypeError(`Source worldview discriminator ${String(key)} must be boolean`);
    return selected;
};
const parse = (value) => {
    if (!record(value))
        throw new TypeError("Source worldview discriminator output must be an object");
...
export const sourceWorldviewDiscriminatorShape = strictShape("source_worldview_neutrality_audit", schema, parse);
/**
 ...
 */
export const deterministicSourcePassageGate = (passage) => {
...
export const sourceWorldviewDiscriminatorInput = (sourceId, passageId, passage) => ({
    instructions: [
...
export const sourceDiscriminatorDecision = (audit) => {
...
//# sourceMappingURL=sourceDiscriminator.js.map