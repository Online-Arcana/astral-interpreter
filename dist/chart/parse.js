...
const refs = (value, name) => textList(value, name).map((item) => {
    if (!item.startsWith("#/"))
        throw new TypeError(`${name} contains a non-local JSON reference`);
    return item;
});
const status = (value) => {
...
export const parseSexualInterpretation = (input) => {
...
export const parseCareerInterpretation = (input) => {
...
export const parseMoneyInterpretation = (input) => {
...
export const parseSystemSynthesis = (input) => {
...
export const parseCompatibilityOverview = (input) => {
...
export const parseSignCompatibility = (input, expectedSign) => {
    ...
    if (value["sign"] !== expectedSign)
        throw new TypeError(`Sign compatibility expected ${expectedSign}`);
    return {
        sign: expectedSign,
...
export const parseCrossSystem = (input) => {
...
export const parseFinalSynthesis = (input) => {
...
export const compatibilityDomain = (domain, overview, signs) => ({
    domain,
