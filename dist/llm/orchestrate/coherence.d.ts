 ...
 */
export declare const coherenceIssues: (_units: Readonly<Record<string, UnitResult<object>>>, _scope: CoherenceScope) => CoherenceIssue[];
export declare const conflictingUnits: (issues: readonly CoherenceIssue[]) => Set<string>;
