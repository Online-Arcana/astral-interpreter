...
export type InterpretationRepairKind = "truncation_condensation" | "completion_condensation" | "audit_correction" | "coherence_correction" | "deterministic_reconstruction" | "xml_fallback" | "coherence_reconstruction";
...
export type InterpretationFailureKind = "transport" | "rate_limit" | "timeout" | "truncation" | "schema" | "audit" | "coherence";
...
export type InterpretationDiagnosticKind = "start" | "retry" | "reject" | "complete" | "checkpoint" | "wave";
...
export interface RunHooks {
    ...
    onReject?: (unit: InterpretationCall, attempt: number, model: string, output: object, audit: UnitAudit<object>) => void | Promise<void>;
